...
If SMB port 445 is open AND signing is disabled →
    ...
    → Check: [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/Active Directory/SMB Relay]]

If LLMNR/NBT-NS traffic is present →
    → Poison responses to capture hashes  
    → Check: [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/LLMNR Poisoning]]

If IPv6 is active →
    → Rogue RA / DHCPv6 attacks possible  
    → Check: [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/IPv6 Attacks]]
...
If usernames are recovered →
    → Begin spraying  
    → Check: [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/Credential Stuffing & Password Spraying]]  
    → Or brute if conditions allow: [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/Brute-Force Attacks]]
...
- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/LLMNR Poisoning]]
- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/Active Directory/SMB Relay]]
- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/IPv6 Attacks]]

- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/2_Enumeration/Enumerating SMB]]
- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/2_Enumeration/Enumerating Vulnerabilities]]
...
- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/Brute-Force Attacks]]
- [[2_Studies/Courses/Current/CERTPREP - CPTS/1_Hack.codex/3_Exploitation/Hashcracking]]
